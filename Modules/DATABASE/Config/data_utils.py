...
def backup_database():
    ...
    """
    print(
        Fore.MAGENTA + "This script will attempt to backup your PostgreSQL database running in Docker." + Style.RESET_ALL)
    print(
        Fore.MAGENTA + "Ensure your 'my-postgres-db' container is running and your Docker Compose credentials match." + Style.RESET_ALL)
